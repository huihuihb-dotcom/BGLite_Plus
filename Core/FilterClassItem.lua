...
function BG.FilterClassItemUI()
    ...
    local function CreateFilterButton(table, tilte, tilte_onenter, type, pailie) --BG.FilterClassItemDB[type]
        ...
        for i, v in ipairs(table) do
            ...
            if BG.FilterClassItemMainFrame:GetTop() and bt:GetBottom() then BG.FilterClassItemMainFrame:SetHeight(BG.FilterClassItemMainFrame:GetTop() - bt:GetBottom() + 40) end
