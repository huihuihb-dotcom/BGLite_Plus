...
function BG.RoleOverviewUI()
    player = UnitName("player") or BG.playerName or player
    realmID = GetRealmID() or realmID
    ...
    do
        ...
        if BG.IsVanilla_Sod then
            BG.FBCDall_table = {
                { name = "BWLsod", shortName = "BWL", color = "00BFFF", fbId = 469, type = "fb" },
                { name = "MCsod", shortName = "MC", color = "00BFFF", fbId = 409, type = "fb" },
                { name = "ZUGsod", shortName = "ZG", color = "00BFFF", fbId = 309, type = "fb" },
                { name = "TCV", name2 = L["风王子"], shortName = L["风王子"], color = "00BFFF", fbId = 2804, type = "fb" },
                { name = "OLsod", name2 = L["黑龙"], shortName = L["黑龙"], color = "00BFFF", fbId = 249, type = "fb" },
                { name = "SC", name2 = L["蓝龙"], shortName = L["蓝龙"], color = "00BFFF", fbId = 2791, type = "fb" },
                { name = "TTS", name2 = L["卡扎克"], shortName = L["卡扎克"], color = "00BFFF", fbId = 2789, type = "fb" },
                { name = "Temple", shortName = L["神庙"], color = "00BFFF", fbId = 109, type = "fb" },
                { name = "Gno", shortName = L["诺莫"], color = "00BFFF", fbId = 90, type = "fb" },
                { name = "BD", shortName = L["深渊"], color = "00BFFF", fbId = 48, type = "fb" },
                -- 任务
        ...
        elseif BG.IsVanilla_60 then
            BG.FBCDall_table = {
                { name = "NAXX", name2 = L["纳克萨玛斯"], shortName = "NAXX", color = "00BFFF", fbId = 533, num = 40, type = "fb" },
                { name = "TAQ", name2 = L["安其拉"], shortName = "TAQ", color = "00BFFF", fbId = 531, num = 40, type = "fb" },
                { name = "AQL", name2 = L["废墟"], shortName = L["废墟"], color = "00BFFF", fbId = 509, num = 20, type = "fb" },
                { name = "ZUG", name2 = L["祖格"], shortName = "ZG", color = "00BFFF", fbId = 309, num = 20, type = "fb" },
                { name = "BWL", name2 = L["黑翼"], shortName = "BWL", color = "00BFFF", fbId = 469, num = 40, type = "fb" },
                { name = "OL", name2 = L["黑龙"], shortName = L["黑龙"], color = "00BFFF", fbId = 249, num = 40, type = "fb" },
                { name = "MC", name2 = L["熔火之心"], shortName = "MC", color = "00BFFF", fbId = 409, num = 40, type = "fb" },
                -- 专业
        ...
        elseif BG.IsTBC then
            BG.FBCDall_table = {
                { name = "SW", name2 = L["太阳井"], shortName = "SW", color = "00BFFF", fbId = 580, num = 25, type = "fb" },
                { name = "BT", name2 = L["黑庙"], shortName = "BT", color = "00BFFF", fbId = 564, num = 25, type = "fb" },
                { name = "HS", name2 = L["海山"], shortName = "HS", color = "00BFFF", fbId = 534, num = 25, type = "fb" },
                { name = "ZA", name2 = L["祖阿曼"], shortName = "ZA", color = "00BFFF", fbId = 568, num = 10, type = "fb" },
                { name = "TK", name2 = L["风暴"], shortName = "TK", color = "00BFFF", fbId = 550, num = 25, type = "fb" },
                { name = "SSC", name2 = L["毒蛇"], shortName = "SSC", color = "00BFFF", fbId = 548, num = 25, type = "fb" },
                { name = "GL", name2 = L["格鲁尔"], shortName = "GL", color = "00BFFF", fbId = 565, num = 25, type = "fb" },
                { name = "ML", name2 = L["玛胖"], shortName = "ML", color = "00BFFF", fbId = 544, num = 25, type = "fb" },
                { name = "KZ", name2 = L["卡拉赞"], shortName = "KZ", color = "00BFFF", fbId = 532, num = 10, type = "fb" },
                -- 日常
        ...
        elseif BG.IsWLK_80 then
            BG.FBCDall_table = {
                --WLK
                { name = "25RS", name2 = L["25红玉"], shortName = "25RS", color = "FF4500", fbId = 724, num = 25, type = "fb" },
                { name = "10RS", name2 = L["10红玉"], shortName = "10RS", color = "FF4500", fbId = 724, num = 10, type = "fb" },
                { name = "25ICC", name2 = L["25冰冠"], shortName = "25ICC", color = "9370DB", fbId = 631, num = 25, type = "fb" },
                { name = "10ICC", name2 = L["10冰冠"], shortName = "10ICC", color = "9370DB", fbId = 631, num = 10, type = "fb" },
                { name = "25TOC", name2 = L["25十字军"], shortName = "25TOC", color = "FF69B4", fbId = 649, num = 25, type = "fb" },
                { name = "10TOC", name2 = L["10十字军"], shortName = "10TOC", color = "FF69B4", fbId = 649, num = 10, type = "fb" },
                { name = "25OL", name2 = L["25黑龙"], shortName = "25黑龙", color = "FFA500", fbId = 249, num = 25, type = "fb" },
                { name = "10OL", name2 = L["10黑龙"], shortName = "10黑龙", color = "FFA500", fbId = 249, num = 10, type = "fb" },
                { name = "25ULD", name2 = L["25奥杜尔"], shortName = "25ULD", color = "00BFFF", fbId = 603, num = 25, type = "fb" },
                { name = "10ULD", name2 = L["10奥杜尔"], shortName = "10ULD", color = "00BFFF", fbId = 603, num = 10, type = "fb" },
                { name = "25NAXX", name2 = L["25纳克"], shortName = "25NAXX", color = "32CD32", fbId = 533, num = 25, type = "fb" },
                { name = "10NAXX", name2 = L["10纳克"], shortName = "10NAXX", color = "32CD32", fbId = 533, num = 10, type = "fb" },
                { name = "25EOE", name2 = L["25蓝龙"], shortName = "25蓝龙", color = "1E90FF", fbId = 616, num = 25, type = "fb" },
                { name = "10EOE", name2 = L["10蓝龙"], shortName = "10蓝龙", color = "1E90FF", fbId = 616, num = 10, type = "fb" },
                { name = "25OS", name2 = L["25黑曜石"], shortName = "25黑曜", color = "8B4513", fbId = 615, num = 25, type = "fb" },
                { name = "10OS", name2 = L["10黑曜石"], shortName = "10黑曜", color = "8B4513", fbId = 615, num = 10, type = "fb" },
                { name = "25VOA", name2 = L["25宝库"], shortName = "25宝库", color = "FFFF00", fbId = 624, num = 25, type = "fb" },
                { name = "10VOA", name2 = L["10宝库"], shortName = "10宝库", color = "FFFF00", fbId = 624, num = 10, type = "fb" },
                --TBC
                { name = "SW", name2 = L["太阳井"], shortName = "SW", color = "D3D3D3", fbId = 580, num = 25, type = "fb" },
                { name = "BT", name2 = L["黑庙"], shortName = "BT", color = "D3D3D3", fbId = 564, num = 25, type = "fb" },
                { name = "HS", name2 = L["海山"], shortName = "HS", color = "D3D3D3", fbId = 534, num = 25, type = "fb" },
                { name = "TK", name2 = L["风暴"], shortName = "TK", color = "D3D3D3", fbId = 550, num = 25, type = "fb" },
                { name = "SSC", name2 = L["毒蛇"], shortName = "SSC", color = "D3D3D3", fbId = 548, num = 25, type = "fb" },
                { name = "GL", name2 = L["格鲁尔"], shortName = "GL", color = "D3D3D3", fbId = 565, num = 25, type = "fb" },
                { name = "ML", name2 = L["玛胖"], shortName = "ML", color = "D3D3D3", fbId = 544, num = 25, type = "fb" },
                { name = "ZA", name2 = L["祖阿曼"], shortName = "ZA", color = "D3D3D3", fbId = 568, num = 10, type = "fb" },
                { name = "KZ", name2 = L["卡拉赞"], shortName = "KZ", color = "D3D3D3", fbId = 532, num = 10, type = "fb" },
                { name = "PT", name2 = L["平台"], shortName = L["平台"], color = "D3D3D3", fbId = 585, num = 5, type = "fb" },
                { name = "STK", name2 = L["塞泰克"], shortName = L["塞泰克"], color = "D3D3D3", fbId = 556, num = 5, type = "fb" },
                --CLASSIC
                { name = "TAQ", name2 = L["安其拉"], shortName = "TAQ", color = "D3D3D3", fbId = 531, num = 40, type = "fb" },
                { name = "AQL", name2 = L["废墟"], shortName = L["废墟"], color = "D3D3D3", fbId = 509, num = 20, type = "fb" },
                { name = "ZUG", name2 = L["祖格"], shortName = "ZG", color = "D3D3D3", fbId = 309, num = 20, type = "fb" },
                { name = "BWL", name2 = L["黑翼"], shortName = "BWL", color = "D3D3D3", fbId = 469, num = 40, type = "fb" },
                { name = "MC", name2 = L["熔火之心"], shortName = "MC", color = "D3D3D3", fbId = 409, num = 40, type = "fb" },
                -- 日常
        ...
        elseif BG.IsTitan then
            BG.FBCDall_table = {
                ...
                { name = "ZUGtitan", name2 = L["祖格"], shortName = "ZG", color = "00BFFF", fbId = 309, type = "fb" },
                { name = "NAXXtitan", name2 = L["纳克萨玛斯"], shortName = "NAXX", color = "00BFFF", fbId = 533, type = "fb" },
                { name = "OStitan", name2 = L["黑曜石"], shortName = "OS", color = "00BFFF", fbId = 615, type = "fb" },
                { name = "EOEtitan", name2 = L["永恒之眼"], shortName = "EOE", color = "00BFFF", fbId = 616, type = "fb" },
                { name = "SSCtitan", name2 = L["毒蛇神殿"], shortName = "SSC", color = "00BFFF", fbId = 548, type = "fb" },
                { name = "TKtitan", name2 = L["风暴要塞"], shortName = "TK", color = "00BFFF", fbId = 550, type = "fb" },
                { name = "MCtitan", name2 = L["熔火之心"], shortName = "MC", color = "00BFFF", fbId = 409, type = "fb" },
                { name = "VOAtitan", name2 = L["阿尔卡冯宝库"], shortName = "宝库", color = "00BFFF", fbId = 624, type = "fb" },
                { name = "Doomwalker", name2 = L["末日行者"], shortName = "机甲", color = "99ccff", fbId = 119, type = "fb" },
                { name = "DoomLordKazzak", name2 = L["末日领主"], shortName = "领主", color = "99ccff", fbId = 118, type = "fb" },
                { name = "Lanlongtitan", name2 = L["蓝龙(世界)"], shortName = "蓝龙", color = "99ccff", fbId = 116, type = "fb" },
                ...
                -- TBC 经典补充团本
                { name = "BT", name2 = L["黑暗神殿"], shortName = "BT", color = "D3D3D3", fbId = 564, num = 25, type = "fb" },
                { name = "HS", name2 = L["海加尔山"], shortName = "HS", color = "D3D3D3", fbId = 534, num = 25, type = "fb" },
                { name = "GL", name2 = L["格鲁尔"], shortName = "GL", color = "D3D3D3", fbId = 565, num = 25, type = "fb" },
                { name = "ML", name2 = L["玛瑟里顿"], shortName = "ML", color = "D3D3D3", fbId = 544, num = 25, type = "fb" },
                { name = "KZ", name2 = L["卡拉赞"], shortName = "KZ", color = "D3D3D3", fbId = 532, num = 10, type = "fb" },

                -- 60 经典旧世补充团本
                { name = "TAQ", name2 = L["安其拉神殿"], shortName = "TAQ", color = "D3D3D3", fbId = 531, num = 40, type = "fb" },
                { name = "AQL", name2 = L["安其拉废墟"], shortName = "废墟", color = "D3D3D3", fbId = 509, num = 20, type = "fb" },
                { name = "BWL", name2 = L["黑翼之巢"], shortName = "BWL", color = "D3D3D3", fbId = 469, num = 40, type = "fb" },
        ...
        elseif BG.IsCTM then
            BG.FBCDall_table = {
                -- CTM
                { name = "DS", name2 = GetRealZoneText(967), shortName = "DS", color = "9370DB", fbId = 967, type = "fb" },
                { name = "FL", name2 = GetRealZoneText(720), shortName = "FL", color = "FF4500", fbId = 720, type = "fb" },
                { name = "BOT", name2 = GetRealZoneText(671), shortName = "BOT", color = "FFFF00", fbId = 671, type = "fb" },
                { name = "BWD", name2 = GetRealZoneText(669), shortName = "BWD", color = "FF1493", fbId = 669, type = "fb" },
                { name = "TOF", name2 = GetRealZoneText(754), shortName = "TOF", color = "87CEFA", fbId = 754, type = "fb" },
                { name = "25BH", name2 = "25" .. GetRealZoneText(757), shortName = "25BH", color = "8B4513", fbId = 757, num = 25, type = "fb" },
                { name = "10BH", name2 = "10" .. GetRealZoneText(757), shortName = "10BH", color = "8B4513", fbId = 757, num = 10, type = "fb" },
                --WLK
                { name = "25RS", name2 = L["25红玉"], shortName = "25RS", color = "FF4500", fbId = 724, num = 25, type = "fb" },
                { name = "10RS", name2 = L["10红玉"], shortName = "10RS", color = "FF4500", fbId = 724, num = 10, type = "fb" },
                { name = "25ICC", name2 = L["25冰冠"], shortName = "25ICC", color = "9370DB", fbId = 631, num = 25, type = "fb" },
        ...
        elseif BG.IsMOP then
            BG.FBCDall_table = {
                -- MOP
                { name = "SOO", name2 = GetRealZoneText(1136), shortName = "SOO", color = "00ff00", fbId = 1136, type = "fb" },
                { name = "TOT", name2 = GetRealZoneText(1098), shortName = "TOT", color = "00ff00", fbId = 1098, type = "fb" },
                { name = "TES", name2 = GetRealZoneText(996), shortName = "TES", color = "00ff00", fbId = 996, type = "fb" },
                { name = "HOF", name2 = GetRealZoneText(1009), shortName = "HOF", color = "00ff00", fbId = 1009, type = "fb" },
                { name = "MSV", name2 = GetRealZoneText(1008), shortName = "MSV", color = "00ff00", fbId = 1008, type = "fb" },
                { name = "worldBoss6", name2 = L["野牛人"], shortName = L["野牛人"], color = "99ff99", type = "worldBoss" },
                { name = "worldBoss5", name2 = L["四天神"], shortName = L["四天神"], color = "99ff99", type = "worldBoss" },
                { name = "worldBoss4", name2 = L["乌达斯塔"], shortName = L["乌达斯塔"], color = "99ff99", type = "worldBoss" },
                { name = "worldBoss3", name2 = L["暴风领主"], shortName = L["暴风领主"], color = "99ff99", type = "worldBoss" },
                { name = "worldBoss2", name2 = L["怒之煞"], shortName = L["怒之煞"], color = "99ff99", type = "worldBoss" },
                { name = "worldBoss1", name2 = L["炮舰"], shortName = L["炮舰"], color = "99ff99", type = "worldBoss" },
                -- CTM
                { name = "DS", name2 = GetRealZoneText(967), shortName = "DS", color = "9370DB", fbId = 967, type = "fb" },
                { name = "FL", name2 = GetRealZoneText(720), shortName = "FL", color = "FF4500", fbId = 720, type = "fb" },
                { name = "BOT", name2 = GetRealZoneText(671), shortName = "BOT", color = "FFFF00", fbId = 671, type = "fb" },
                { name = "BWD", name2 = GetRealZoneText(669), shortName = "BWD", color = "FF1493", fbId = 669, type = "fb" },
                { name = "TOF", name2 = GetRealZoneText(754), shortName = "TOF", color = "87CEFA", fbId = 754, type = "fb" },
                { name = "25BH", name2 = "25" .. GetRealZoneText(757), shortName = "25BH", color = "FFA500", fbId = 757, num = 25, type = "fb" },
                { name = "10BH", name2 = "10" .. GetRealZoneText(757), shortName = "10BH", color = "FFA500", fbId = 757, num = 10, type = "fb" },
                --WLK
                { name = "25RS", name2 = L["25红玉"], shortName = "25RS", color = "FF4500", fbId = 724, num = 25, type = "fb" },
                { name = "10RS", name2 = L["10红玉"], shortName = "10RS", color = "FF4500", fbId = 724, num = 10, type = "fb" },
                { name = "25ICC", name2 = L["25冰冠"], shortName = "25ICC", color = "9370DB", fbId = 631, num = 25, type = "fb" },
...
GameTooltip:SetCurrencyByID(697)
        ...
        elseif BG.IsRetail then
            BG.FBCDall_table = {
                { name = "VS_M", name2 = GetRealZoneText(2912), shortName = "VS", color = "00BFFF", fbId = 2912, diff = 16, type = "fb" },
                { name = "DR_M", name2 = GetRealZoneText(2939), shortName = "DR", color = "00BFFF", fbId = 2939, diff = 16, type = "fb" },
                { name = "MQD_M", name2 = GetRealZoneText(2913), shortName = "MQD", color = "00BFFF", fbId = 2913, diff = 16, type = "fb" },
                { name = "VS_H", name2 = GetRealZoneText(2912), shortName = "VS", color = "00BFFF", fbId = 2912, diff = 15, type = "fb" },
                { name = "DR_H", name2 = GetRealZoneText(2939), shortName = "DR", color = "00BFFF", fbId = 2939, diff = 15, type = "fb" },
                { name = "MQD_H", name2 = GetRealZoneText(2913), shortName = "MQD", color = "00BFFF", fbId = 2913, diff = 15, type = "fb" },
                { name = "VS_N", name2 = GetRealZoneText(2912), shortName = "VS", color = "00BFFF", fbId = 2912, diff = 14, type = "fb" },
                { name = "DR_N", name2 = GetRealZoneText(2939), shortName = "DR", color = "00BFFF", fbId = 2939, diff = 14, type = "fb" },
                { name = "MQD_N", name2 = GetRealZoneText(2913), shortName = "MQD", color = "00BFFF", fbId = 2913, diff = 14, type = "fb" },
            }
    ...
    do
        ...
        function BG.UpdateFBCD()
            ...
            player = UnitName("player") or BG.playerName or player
            realmID = GetRealmID() or realmID
            colorplayer = colorplayer or SetClassCFF(player, "player")
            if BiaoGe and player and realmID and player ~= "" then
                BiaoGe[FBCD] = BiaoGe[FBCD] or {}
                BiaoGe[FBCD][realmID] = BiaoGe[FBCD][realmID] or {}
                if next(cd) then
    ...
    elseif BG.IsTitan then
        local function GetBossIsKill()
            ...
            if instanceID == 0 or instanceID == 1 or instanceID == 530 then
                RequestRaidInfo()
            end
        end
        C_Timer.NewTicker(5, function()
    ...
    do
        ...
        local function IsLearnSkill(skillID)
            local pData = BiaoGe and BiaoGe[MONEY] and realmID and player and BiaoGe[MONEY][realmID] and BiaoGe[MONEY][realmID][player]
            return pData and pData.skill and pData.skill[skillID]
        end
    ...
    if not BG.IsRetail then
        ...
        local function UpdatetradeSkill()
            ...
            player = UnitName("player") or BG.playerName or player
            realmID = GetRealmID() or realmID
            if not (player and realmID and player ~= "") then return end
            if not (BiaoGe and BiaoGe[MONEY]) then return end
            BiaoGe[MONEY][realmID] = BiaoGe[MONEY][realmID] or {}
            BiaoGe[MONEY][realmID][player] = BiaoGe[MONEY][realmID][player] or {}
