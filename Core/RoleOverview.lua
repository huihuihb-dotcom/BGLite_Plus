    ...
    do
        ...
        elseif BG.IsTitan then
            BG.FBCDall_table = {
                ...
                { name = "EOEtitan", name2 = L["永恒之眼"], color = "00BFFF", fbId = 616, type = "fb" },
                { name = "SSCtitan", name2 = L["毒蛇神殿"], color = "00BFFF", fbId = 548, type = "fb" },
                { name = "TKtitan", name2 = L["风暴要塞"], color = "00BFFF", fbId = 550, type = "fb" },
                { name = "MCtitan", name2 = L["熔火之心"], color = "00BFFF", fbId = 409, type = "fb" },
                { name = "VOAtitan", name2 = L["阿尔卡冯宝库"], color = "00BFFF", fbId = 624, type = "fb" },
                { name = "Doomwalker", name2 = L["末日行者"], color = "99ccff", fbId = 119, type = "fb" },
                { name = "DoomLordKazzak", name2 = L["末日领主"], color = "99ccff", fbId = 118, type = "fb" },
                { name = "Lanlongtitan", name2 = L["蓝龙(世界)"], color = "99ccff", fbId = 116, type = "fb" },
                { name = "Kazaketitan", name2 = L["卡扎克(世界)"], color = "99ccff", fbId = 117, type = "fb" },

                -- WLK 经典/后续扩展团本
                { name = "25ULD", name2 = L["奥杜尔"], color = "00BFFF", fbId = 603, num = 25, type = "fb" },
                { name = "25ICC", name2 = L["冰冠堡垒"], color = "9370DB", fbId = 631, num = 25, type = "fb" },
                { name = "25RS", name2 = L["红玉圣殿"], color = "FF4500", fbId = 724, num = 25, type = "fb" },
                { name = "25OL", name2 = L["黑龙MM"], color = "FFA500", fbId = 249, num = 25, type = "fb" },

                -- TBC 经典补充团本
                { name = "BT", name2 = L["黑暗神殿"], color = "D3D3D3", fbId = 564, num = 25, type = "fb" },
                { name = "HS", name2 = L["海加尔山"], color = "D3D3D3", fbId = 534, num = 25, type = "fb" },
                { name = "GL", name2 = L["格鲁尔"], color = "D3D3D3", fbId = 565, num = 25, type = "fb" },
                { name = "ML", name2 = L["玛瑟里顿"], color = "D3D3D3", fbId = 544, num = 25, type = "fb" },
                { name = "KZ", name2 = L["卡拉赞"], color = "D3D3D3", fbId = 532, num = 10, type = "fb" },

                -- 60 经典旧世补充团本
                { name = "TAQ", name2 = L["安其拉神殿"], color = "D3D3D3", fbId = 531, num = 40, type = "fb" },
                { name = "AQL", name2 = L["安其拉废墟"], color = "D3D3D3", fbId = 509, num = 20, type = "fb" },
                { name = "BWL", name2 = L["黑翼之巢"], color = "D3D3D3", fbId = 469, num = 40, type = "fb" },
