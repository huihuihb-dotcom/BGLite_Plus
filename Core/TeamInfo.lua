...
function TeamInfo.CreateUI()
    ...
    yyEdit:SetScript("OnEnterPressed", function(self)
        self:ClearFocus()
    end)
    yyEdit:SetScript("OnEscapePressed", function(self)
        self:ClearFocus()
    end)
    yyEdit:SetScript("OnEditFocusLost", function(self)
        self:ClearFocus()
    end)
    ...
    threshEdit:SetScript("OnEscapePressed", function(self)
        self:ClearFocus()
    end)
