...
function ns.InitFilterClassItemDB()
    ...
    do
        ...
        if BG.verOver3 and not BG.IsRetail then
            ...
            if RealmID and player and BiaoGe.FilterClassItemDB[RealmID] and BiaoGe.FilterClassItemDB[RealmID][player] then
                for i = 1, (BG.MaxFilter or 3) do
                    if BiaoGe.FilterClassItemDB[RealmID][player][i] then
