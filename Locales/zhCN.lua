...
BINDING_HEADER_BIAOGE = BINDING_HEADER_BIAOGE or "|cff00BFFF金团表格|r BiaoGe"
BINDING_NAME_ROLEOVERVIEW = "打开/关闭 角色总览"
...
do --简体说明书
    ...
    ns.updateText_before = {
        ...
        " " ,
        "|cff00FF00" ..[[8月8日更新v2.2.9]] ,
        [[-<时光服>更新太阳井掉落数据]] ,
        [[-<时光服>修复了角色总览不显示橙弓的问题]] ,
        [[-<MOP>奥格的战火装备现在支持一键拍卖了]],
        [[-<MOP>角色总览：增加"永恒铸币"]],
        " " ,
        "|cff00FF00" ..[[8月6日更新v2.2.8]] ,
        [[-<时光服>修复P5表格格子不够的问题]] ,
        " " ,
        "|cff00FF00" ..[[8月6日更新v2.2.7]] ,
        [[-<时光服>P5装备库：更新100多件牌子装]] ,
        " " ,
        "|cff00FF00" ..[[8月5日更新v2.2.6]] ,
        [[-新增功能：进组欢迎语（入口在表格底部）]] ,
        [[-以下模块现在允许禁用，按钮在相应模块界面右下角：交易记录、邮寄记录、团长历史喊话、进组欢迎语]] ,
        [[-<时光服>P5装备库：更新太阳之尘可兑换的装备]] ,
        " " ,
        "|cff00FF00" ..[[8月3日更新v2.2.5]] ,
        [[-<MOP>增加奥格部分BOSS的站位图材质]] ,
        [[-修复报错]] ,
        " " ,
        "|cff00FF00" ..[[8月3日更新v2.2.4]] ,
        [[-历史账单汇总：增加显示我的所有角色合计消费与合计工资]] ,
        [[-联动TuanJian插件，增加减伤链接收端]] ,
        [[-<MOP>修复了装备库T16套装兑换件错误的问题]] ,
    }
end
...
do -- 进组欢迎语
    ...
    L["仅团长/助理"] = "仅团长/助理"
    L["仅团长/助理生效"] = "仅团长/助理生效"
    L["勾选后，只有当自己是团长或团队助理(A)时，才会自动发送进组密语或团队通知，避免进入他人团队时产生误发。"] = "勾选后，只有当自己是团长或团队助理(A)时，才会自动发送进组密语或团队通知，避免进入他人团队时产生误发。"
    L["* 当前已启用[仅限团长/助理]，仅在拥有管理权限时发送。"] = "* 当前已启用[仅限团长/助理]，仅在拥有管理权限时发送。"
    L["当有新玩家加入队伍或团队时，自动向其发送设定的密语（支持 {name} 自动替换）。"] = "当有新玩家加入队伍或团队时，自动向其发送设定的密语（支持 {name} 自动替换）。"
    L["当有新玩家加入队伍或团队时，自动在团队/小队频道发送进组欢迎公告。"] = "当有新玩家加入队伍或团队时，自动在团队/小队频道发送进组欢迎公告。"
end
...
do -- 减伤链接收器
    ...
    -- TeamInfo 语音频道
    L["语音频道:"] = true
    L["已将当前团队招募语与语音频道成功绑定至 <%s> 表格！"] = true
    L["团长发布语音频道: "] = true
    L["自动捕获集结号、世界喊话与开团规则，支持语音频道一键复制及副本账单自动绑定。"] = true
    L["如遇任何异常或有优化建议，欢迎前往 语音频道(DD): 434056 交流反馈！"] = true
    L["已开启队伍监听，自动捕获集结号、语音频道与开团规则..."] = true
    L["已将语音频道放入输入框: "] = true
    L["当前没有记录到有效的语音频道"] = true
    ...
    L["点击展开心理价格管理面板。"] = true
    L["开拍自动出价接管："] = true
    L["当拍卖清单中的装备时，插件会自动填入该心理价并开启自动出价，能捡漏则捡漏、逐级加一手跟进直至封顶。"] = true
    L["快捷设定：按住 ALT 并右键点击任何装备格子即可快速添加！"] = true
    ...
    -- 角色总览显示隐藏角色
    L["角色显示自定义队列"] = true
    L["（勾选的角色将在角色总览中展示，未勾选的将被隐藏）"] = true
    L["显示/隐藏角色："] = true
    L["管理角色显示"] = true
    L["全部显示"] = true
    L["仅当前角色"] = true
    ...
    L["角色显示管理"] = true
    L["隐藏此角色"] = true
    L["确定在角色总览中隐藏角色 %s 吗？\n（可随时在 [插件设置-角色总览] 中重新开启显示）"] = true
    L["已隐藏角色：%s，若需重新显示可在 [插件设置-角色总览] 中开启。"] = true

    -- 团队工具进组自动通知
    L["仅团队生效"] = true
    L["仅在团队(Raid)中生效 (推荐)"] = true
    L["勾选(默认)：仅在团队活动中生效，5人小队或地下城中绝不发送，杜绝打日常5人本时的误发。"] = true
    L["反选(取消勾选)：允许在5人小队中生效，当队长组人时正常发送进组密语和小队频道欢迎公告。"] = true
    L["勾选后，只有当自己是团长或团队助理(A)时，才会自动发送进组密语或团队通知（在小队中则需为小队长），避免进入他人队伍时产生误发。"] = true
    L["* 当前已启用[仅在团队生效]，5人小队中不会发送。"] = true

    -- 掉落记录 (防漏少记)
    L["掉落记录"] = true
    L["< 掉落记录 >"] = true
    L["团队副本所有掉落拾取流水记录，实时核对金团表格防漏少记。"] = true
    L["仅看未记入"] = true
    L["仅看未记入表格的装备 (防漏少记)"] = true
    L["仅看紫装/橙装"] = true
    L["仅看史诗及以上品质的装备"] = true
    L["通报未记入"] = true
    L["将未记入金团表格的掉落装备通报至团队/小队频道"] = true
    L["搜索物品或玩家..."] = true
    L["清空记录"] = true
    L["确定要清空当前副本的掉落拾取记录吗？"] = true
end
