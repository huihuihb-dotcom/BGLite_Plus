...
do -- 减伤链接收器
    ...
    L["3个最小 (前3名)"] = true
    L["选最小 (1人)"] = true
    L["禁止多次R点 (未勾选默认只取首次)"] = true
    L["禁止多次R点 (多次剔除资格)"] = true
    L["多次R点规则设置"] = true
    L["【未勾选 (默认)】：不限制重复投掷，系统自动仅采纳每位玩家的第一次R点成绩，后续投掷全部忽略。"] = true
    L["【勾选此项 (严格防作弊)】：若有玩家投掷了 2 次或以上，直接取消其获胜资格，胜出名额严格按规则顺延，并在通报中公示违规名单。"] = true
    L["禁止多次参与 (公平防作弊)"] = true
    L["编辑开场语"] = true
    L["已完成投掷"] = true
    L["已截止"] = true
